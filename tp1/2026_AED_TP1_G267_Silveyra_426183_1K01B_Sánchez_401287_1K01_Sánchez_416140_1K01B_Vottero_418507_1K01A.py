...
if letra == "J" and bloque % 2 == 0:
    recargo_j = (monto_base * 12) / 100
    if recargo_j > 25000:
        recargo_j = 25000
    monto_final = monto_base + 25000 + recargo_j
else:
...
if letra != "J" and letra != "K":
    recargo_8 = (monto_final * 8 ) /100
    monto_final += recargo_8
